defmodule TelluridePipeline.Messaging.ThroughputProducer do
  use GenServer

  alias __MODULE__

  @exchange       "broadway_events"
  @message_queue  "broadway_throughput_queue"
  @routing_key    "broadway.throughput"
  ...
  def publish(message) when is_map(message) do
    ...
    ThroughputProducer.publish(json)
  end
